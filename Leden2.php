        ...
        <div class="container">
            <div class="table-responsive">
                ...
                <?php if(isset($_POST['verwijderen2'])){
                        ...
                        Else {die("<p class=\"text-center\"><h2>Lid verwijderd!</h2> <a href=\"./Leden2.php\" class=\"btn btn-primary mb-2\">Terug naar de ledenpagina</a></p>");}
                    }?>
            </div>
        </div>
<?php 
	...
	Else{
			...
			if ($result !=1) {Echo "er is iets fout gegaan bij het verwijderen. Foutcode: $result"; die;}
